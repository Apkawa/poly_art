# Django settings for poly_art project.
import os
pwd = os.sys.path[0]
pathsep = os.path.sep
...
DATABASE_NAME = 'db/art.sql'             # Or path to database file if using sqlite3.
...
STATIC_DOC_ROOT = pwd+pathsep+'static'
...
SECRET_KEY = '&kuw2p_v7*v-t_=wt9-0$8ai^q)f^=*21j3l6i6yj+jpl95s0^'
